...
function Home() {
  ...
  <div className="container-fluid">
    ...
    <div>
        ...
        <Link to='/userhome' className="btn btn-outline-success me-5" type="submit">USER</Link>
        <Link to='/servicehome' className="btn btn-outline-success me-5" type="submit">SERVICE PROVIDER</Link>
        </div>
  </div>
</nav>
